...
export default function SideMenuModal({showMenu, shrink, userInfo, setShowMenu, children}) {
  ...
  return (
    <SideMenuModal_ userInfo={userInfo} className='mobile-menu' show={showMenu} onClick={closeMenu}>
