    ...
    deposit: async (req, res)=> {
        try{
            ...
            const chargeData = {
                ...
                redirect_url: PRODUCTION ? `${DOMAIN}dashboard/deposit` : `${DOMAIN_DEV}dashboard/deposit`,
                cancel_url: PRODUCTION ? `${DOMAIN}dashboard/deposit` : `${DOMAIN_DEV}dashboard/deposit`
            }
